...
const { GetAllTeacher, countTeacher,GetSingleTeacher, CreateTeacher, UpdateTeacher, ChangeStatus, DeleteTeacher, GetTeacherPagination } = require('../controllers/teacher');
